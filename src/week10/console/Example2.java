...
//        InputStream in = System.in.read();
        ...
        // util class
        // this is what we used until now - but not in the scope for IO


        // wrapping low level stream with high level streams
        InputStream inputStream = System.in;
        InputStreamReader inputStreamReader = new InputStreamReader(inputStream); // wants a InputStream
